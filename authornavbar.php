                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse menu--shylock"  id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            <li class="active">
                                <a class="nav-stylehead"style="color: white" href="authorhome.php">Home
                                    <span class="sr-only">(current)</span>
                                </a>
                            </li>
                            <li class="dropdown">
                                <a style="color: white" class="nav-stylehead dropdown-toggle" href="#" data-toggle="dropdown">Manage Books
                                    <b class="caret"></b>
                                </a>

                                <ul class="dropdown-menu agile_short_dropdown">
                                    <li><a href="authorbook.php">Add Book</a></li>
                                    <li><a href="viewbook.php">View Books</a></li>
                                </ul>
                            </li>
                            <li class="active">
                            <a class="nav-stylehead"style="color: white" href="authorprofile.php">My Profile
                                <span class="sr-only">(current)</span>
                            </a>
                            </li>
                            <li class="active">
                            <a class="nav-stylehead"style="color: white" href="changeauthorpassword.php">Change Password
                                <span class="sr-only">(current)</span>
                            </a>
                            </li>
                            <li class="active">
                            <a class="nav-stylehead"style="color: white" href="authorlogout.php">Logout
                                <span class="sr-only">(current)</span>
                            </a>
                            </li>
<!--                            <li class="dropdown">-->
...
<!--                                </a>-->
<!--                                <ul class="dropdown-menu agile_short_dropdown">-->
<!--                                    <li><a href="authorlogout.php">Logout</a></li>-->
<!--                                    <li><a href="changeauthorpassword.php">Change Password</a></li>-->
<!--                                </ul>-->
<!--                            </li>-->
                        </ul>
                    </div>
...
<!--        <div class="navbar-collapse collapse" id="menubar1">-->
<!--            <ul class="navbar-nav nav">-->
<!--                <li><a href="authorhome.php">User Home</a></li>-->
<!--                <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"> Manage books<span class="caret"> </span></a>-->
<!--                    <ul class="dropdown-menu">-->
<!--                        <li><a href="authorbook.php">Add Book</a></li>-->
