...
if(isset($_REQUEST["msg"]))
{
    ...
    {
        echo "<div class='alert alert-warning'><strong>Old Password is wrong</strong></div>";
    }
}
?>
...
<div class="col-md-6 col-md-offset-3">
    <form class="form-horizontal myval" action="actionadminpass.php" method="post">
        <div class="form-group">
            <label class="col-md-4">E-mail</label>
            <div class="col-md-8">
                <input type="email" data-rule-required="true" data-msg-required="This field is required" id="tbemail"
                       name="tbemail" class="form-control" readonly value=<?php echo $_SESSION["email"];?> >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="password" class="form-control" data-rule-required="true"
                       data-rule-equalto="#tbnewpassword" data-msg-equalto="Password and Confirm Password do not match"
